  ...
  return (
    <BaseDialog.Root open={isOpen} onOpenChange={onClose}>
      <BaseDialog.Portal>
        ...
        <BaseDialog.Popup
          className={cn(
            "fixed left-[50%] top-[50%] z-50 grid w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] gap-4 border border-neutral-border bg-default-background p-6 shadow-lg duration-200 animate-in fade-in-0 sm:w-full sm:rounded-xl max-h-[85vh] overflow-y-auto",
            sizes[size],
          )}
        >
