...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
    ({ className, variant = 'primary', size = 'md', ...props }, ref) => {
        const variants = {
            ...
            secondary: 'bg-white text-gray-900 border border-gray-300 hover:bg-gray-50 active:bg-gray-100 shadow-sm',
            link: 'text-blue-600 hover:underline bg-transparent border-transparent hover:text-blue-700 p-0 h-auto',
