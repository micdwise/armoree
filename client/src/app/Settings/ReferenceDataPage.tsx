...
import { ProjectileTypesTab } from "./ProjectileTypesTab";
import { LocationsTab } from "./LocationsTab";
import { AmmoStockRequirementsTab } from "./AmmoStockRequirementsTab";
...
export const ReferenceDataPage = () => {
  ...
  const ActiveComponent =
    tabs.find((t) => t.id === activeTab)?.component || ManufacturersTab;
    ...
    <PageSection>
      <div className="mb-6">
        ...
        <p className="text-subtext-color">
          Manage system reference tables for manufacturers, models, calibers,
          projectile types, locations, and ammunition stock requirements.
        </p>
      </div>
