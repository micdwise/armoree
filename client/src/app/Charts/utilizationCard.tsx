...
export const CardUtilizationDemo3: React.FunctionComponent = () => {
  ...
  return (
    <React.Fragment>
      <b>Note:</b> Custom CSS is used in this demo to align the card title and
      select toggle text to <code>baseline</code> alignment.
      <br />
      <br />
                ...
                <FlexItem>
                  <Chart
                    ...
                    legendData={[
                      {
                        name: "Low",
                        symbol: { fill: chart_color_yellow_100.value },
                      },
                      {
                        name: "Important",
                        symbol: { fill: chart_color_yellow_300.value },
                      },
                      {
                        name: "Moderate",
                        symbol: { fill: chart_color_orange_300.value },
                      },
                      {
                        name: "Critical",
                        symbol: { fill: chart_color_red_orange_400.value },
                      },
                    ]}
